...
#line hidden
        ...
        public virtual void EmptyEmailValidationIsWorkingOnContactUsPage(string name, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Empty email validation is working on Contact Us page", null, @__tags);
#line 4
